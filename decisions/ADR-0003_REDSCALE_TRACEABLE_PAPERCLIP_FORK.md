...
5. Gauss `v0.1.0` e obrigatorio no RedScale. Sua adocao apos o baseline inalterado deve ser explicita, versionada e revisavel separadamente.
...
- A customizacao do produto segue `PRD-002 Workforce Spec v2/PDF`, com Gauss `v0.1.0` obrigatorio e `correnth-ui` limitado a referencia visual.
...
- CI e documentacao de release devem manter checks de licenca/proveniencia e a versao fixada de Gauss.
...
Alterar a versao upstream, abandonar a rastreabilidade do fork, substituir a stack baseline, remover Gauss ou tornar CML embedded exige nova ADR. O arquivamento do prototipo e reversivel somente como operacao de branch historica; promove-lo novamente a baseline exige ADR explicita que superseda esta decisao.
